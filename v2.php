...
$result = /*REMOVED SQL CODE | https://i.imgur.com/DfsjheM.png */
...
$json_episodes           = json_decode(get_episodes("gogo", $identifier_streamid), true);
$episode_count           = 1;
...
foreach($json_episodes as $episode){
    if($episode == $identifier_episode){
        $paramurl = "v2.php?name=$identifier_slugtitle_full&ep=$episode_count";
...
$json = json_decode(get_streams("gogo", array("id" => $identifier_streamid, "ep" => $identifier_episode_current)), true);
...
<html lang="en">
  ...
  <body>
    ...
    <div class="playerpage">
      <div class="subpart eptitle">
        ...
        <div id="toprightplayer">
          ...
          $paramurl = "v2.php?name=$identifier_slugtitle_full&ep=$total";
          echo $paramurl;
	...
	<?php include 'players/v2_player.php'; ?>
  </body>
</html>
