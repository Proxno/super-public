//var malid = '44511';
//var copt = '#gh=gogohd.pro'; //#recmanga
//var utoken = 'c0GjXI84IM';
//var lastAdded = '2022-12-20 17:10:02';
...
function convertLocale(loc){
    const arr = loc.split("-");
    let fir = arr[0].toLowerCase();
    let las = arr[1].toUpperCase();
    return LANGUAGE_BY_LOCALE[fir + "_" + las].split(" (")[0];
}

function convertLocaleF(loc){
    const arr = loc.split("-");
    let fir = arr[0].toLowerCase();
    return fir;
}
...
/* //Uncaught TypeError: Cannot read properties of null (reading 'addEventListener') at player.js:62:42
